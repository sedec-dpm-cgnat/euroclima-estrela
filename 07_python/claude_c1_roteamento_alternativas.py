# -*- coding: utf-8 -*-
"""
EUROCLIMA / Estrela-RS — C1: ROTEAMENTO DAS ALTERNATIVAS REVISADAS.
...
PAR = dict(
    ...
    Q_PICO       = 18000.0,   # m3/s   [NAO CALIBRADO]
    Q_BASE       = 600.0,     # m3/s   [NAO CALIBRADO]
    LAMINA_MM    = 260.0,     # mm     [NAO CALIBRADO]
    Q_SEM_DANO   = 4000.0,    # m3/s   [NAO CALIBRADO]
    DT_H         = 1.0,
...
res.to_csv(os.path.join(D_OUT, "claude_c1_roteamento_alternativas.csv"),
           index=False, sep=";", decimal=",")

pd.set_option("display.width", 240)
print("=" * 132)
print("C1 — REDUCAO DE PICO VERIFICADA POR ALTERNATIVA E REGRA OPERATIVA")
print("=" * 132)
for regra in REGRAS:
    print(f"\n--- regra: {regra.upper()} ---")
...
hid.to_csv(os.path.join(D_OUT, "claude_c1_hidrogramas.csv"),
           index=False, sep=";", decimal=",")
...
sd.to_csv(os.path.join(D_OUT, "claude_c1_sensibilidade_pico.csv"),
          index=False, sep=";", decimal=",")
