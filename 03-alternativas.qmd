...
## Conjunto inicial para o Termo de Referência

Para que a contratação não comece com um universo excessivamente amplo nem antecipe uma
decisão de implantação, o ponto de partida recomendado é a matriz **HEC-00–HEC-06**. A
planta abaixo mostra os seis grupos espaciais que merecem entrar na primeira especificação:
E02 e E04 como base do eixo principal; E08 e E12 como extensões incrementais; GU1 como
hipótese independente no Guaporé; e FQ2 como alternativa lateral no Forqueta. FQ1,
comportas, MC2, CA2, 14J2 e demais eixos permanecem como sensibilidades, a serem abertas
quando os dados e a calibração justificarem.

![Planta didática do conjunto inicial de alternativas para o Termo de Referência.](06_resultados/VALIDACAO/MAPA_ALTERNATIVAS_PONTO_PARTIDA_TR.png){#fig-mapa-ponto-partida-tr width=100%}

![Perfil didático da cascata e da sequência de alternativas que inicia a modelagem HEC-RAS 1D.](06_resultados/VALIDACAO/PERFIL_ALTERNATIVAS_PONTO_PARTIDA_TR.png){#fig-perfil-ponto-partida-tr width=100%}

O perfil não atribui altura de projeto às barragens: as hastes coloridas apenas representam o
envelope de altura admissível usado na triagem e tornam visíveis as restrições de Castro Alves,
Monte Claro e 14 de Julho. GU1 e Forqueta não aparecem como barragens no perfil principal porque
entram no modelo como ramos e afluências laterais. O HEC-00, sem novos reservatórios, é a
referência obrigatória antes dos demais cenários.

No [mapa interativo de alternativas finais](06_resultados/GIS/mapa_interativo_alternativas.html),
o painel **Alternativas finais / TR** permite marcar e desmarcar cada caso. Ao selecionar uma
alternativa, aparecem os marcadores de todos os eixos que a compõem; HEC-00 representa a situação
atual, sem novos reservatórios.
